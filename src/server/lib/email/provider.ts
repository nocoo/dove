...
export type ProviderConfig = { type: "resend"; api_key: string } | { type: "cloudflare" };
...
export function getProviderDomain(provider: EmailProviderRecord | null, env?: Env): string {
	if (provider) {
