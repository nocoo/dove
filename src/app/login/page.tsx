    ...
    <div className="relative flex min-h-screen flex-col bg-background overflow-hidden">
      <div className="flex flex-1 items-center justify-center p-4">
        ...
        <div className="absolute top-4 right-4 z-10 flex items-center gap-1">
          ...
          >
            <svg className="h-[18px] w-[18px]" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" strokeWidth={1.5}>
        ...
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <div className="flex flex-1 flex-col items-center px-6 pt-6 pb-5">
              ...
              <p className="mt-1 text-xs text-muted-foreground">Sign in to your email relay</p>
